...
class ViewProduct:
    ...
    def update(self):
        self.read()
        product_id = int(input("Informe o id do produto que deseja alterar?"))
        ...
        self.controller.update(product_id, product_name, product_description, product_price, selected_categories)
